 ...
 */
public class CurrentEmployeeManagerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_current_employee_manager, container, false);
        ...
        try {
            ...
            asyncHttpClient.post(getContext(), ServerConfig.BASE_URL + "/currentEmployee", stringEntity, "application/json",
                    new AsyncHttpResponseHandler() {
                        ...
                        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                            ...
                            CurrentEmployeeManagerFragment.this.employeeDTOList = gson.fromJson(listTaskJson, type);
                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
                            EmployeeCardViewAdapter adapter = new EmployeeCardViewAdapter(CurrentEmployeeManagerFragment.this.employeeDTOList, CurrentEmployeeManagerFragment.this.getActivity());
