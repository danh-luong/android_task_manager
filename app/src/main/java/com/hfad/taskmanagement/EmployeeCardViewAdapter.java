...
public class EmployeeCardViewAdapter extends
        RecyclerView.Adapter<EmployeeCardViewAdapter.ViewHolder>{
    private List<EmployeeDTO> list;
    private Activity activity;

    public EmployeeCardViewAdapter(List<EmployeeDTO> list, Activity activity) {
        this.list = list;
    ...
    @NonNull
    @Override
    public EmployeeCardViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LinearLayout cardView = (LinearLayout) LayoutInflater.from(parent.getContext())
                .inflate(R.layout.employee_of_group, parent, false);
        return new EmployeeCardViewAdapter.ViewHolder(cardView);
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(EmployeeCardViewAdapter.this.activity, TaskOfEmployeeInManagerActivity.class);
                intent.putExtra("username", list.get(position).getUsername());
                EmployeeCardViewAdapter.this.activity.startActivity(intent);
            }
        });
    }
